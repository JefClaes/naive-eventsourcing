...
{
    public class RecordOnDisk
    {
        private const string Seperator = "+++";

        public RecordOnDisk(Guid aggregateId, IEvent @event)
        {
            if (@event == null)
        ...
        public static RecordOnDisk Deserialize(string value)
        {
            ...
            return new RecordOnDisk(aggregateId, @event);
        }
    }
}
